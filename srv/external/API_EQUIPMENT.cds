...
service API_EQUIPMENT {
  ...
  entity Equipment {
    ...
    function GetRootEquipment() returns many GetRootEquipmentResult_Type;
    ...
    action ResetEquipmentFromInactive() returns DummyFunctionImportResult;
    action RsetEquipFromMarkedForDeletion() returns DummyFunctionImportResult;
    action SetEquipmentToInactive() returns DummyFunctionImportResult;
    action SetEquipToMarkedForDeletion() returns DummyFunctionImportResult;
  };
  ...
  entity EquipClassCharacteristicValue {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Equipment'
    @sap.quickinfo : 'Equipment Number'
    @sap.updatable : 'false'
    ...
    to_Characteristic : Association to EquipmentClassCharacteristic {  };
  };
  ...
  entity EquipmentClassCharacteristic {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Equipment'
    @sap.quickinfo : 'Equipment Number'
    @sap.updatable : 'false'
  ...
  entity EquipProductionResourceTool {
    @sap.display.format : 'UpperCase'
    @sap.label : 'Equipment'
    @sap.quickinfo : 'Equipment Number'
    @sap.updatable : 'false'
  ...
  @cds.external : true
  type GetRootEquipmentResult_Type {
    @sap.label : 'Equipment'
    @sap.quickinfo : 'Equipment Number'
    Equipment : String(18);
  };
  ...
  @cds.external : true
  type GetRootFunctionalLocationResult_Type {
    @sap.label : 'Primary LabelSystem'
    @sap.quickinfo : 'Primary labeling system'
    FuncnlLocLabelIsPrimaryLabel : Boolean;
    @sap.label : 'Functional location'
    FunctionalLocation : String(30);
    @sap.label : 'Functional Location'
    @sap.quickinfo : 'Functional Location Label'
    FunctionalLocationLabelName : String(40);
    @sap.label : 'Version'
    @sap.quickinfo : 'Version of functional location label'
    FunctionalLocationLabelVersion : String(3);
    @sap.label : 'Labeling system'
    @sap.quickinfo : 'Labeling system for functional locations'
    FunctionalLocLabelingSyst : String(1);
  };
  ...
  @cds.external : true
  function GetRootFunctionalLocation(
    @sap.label : 'Equipment'
    @sap.quickinfo : 'Equipment Number'
    Equipment : String(18)
