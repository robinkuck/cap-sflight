...
public class BookingSupplementHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public BookingSupplementHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
