...
public class EquipmentHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public EquipmentHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
