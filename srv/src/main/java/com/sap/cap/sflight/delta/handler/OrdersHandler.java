...
public class OrdersHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public OrdersHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
