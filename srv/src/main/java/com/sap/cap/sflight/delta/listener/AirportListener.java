...
public class AirportListener extends com.sap.cloud.server.odata.DefaultEntityListener {
    ...
    public AirportListener(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
        super();
    ...
    public void beforeSave(EntityValue entityValue) {
        ...
        var entity = (com.sap.cap.sflight.delta.proxy.Airport)entityValue;
        allowUnused(entity);
    }
