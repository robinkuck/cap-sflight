...
public class SupplementTypeHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public SupplementTypeHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
