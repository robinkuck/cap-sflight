...
public class TravelHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public TravelHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
