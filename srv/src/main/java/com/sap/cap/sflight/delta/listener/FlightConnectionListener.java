...
public class FlightConnectionListener extends com.sap.cloud.server.odata.DefaultEntityListener {
    private com.sap.cap.sflight.delta.MainServlet servlet;
    private com.sap.cap.sflight.delta.proxy.ProxyService service;

    public FlightConnectionListener(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
        super();
    ...
    public void beforeSave(EntityValue entityValue) {
        ...
        var entity = (com.sap.cap.sflight.delta.proxy.FlightConnection)entityValue;
        allowUnused(entity);
    }
