...
public abstract class Any_as_com_sap_cap_sflight_delta_proxy_Travel
{
    public static com.sap.cap.sflight.delta.proxy.Travel cast(final Object value)
    {
        if (value instanceof com.sap.cap.sflight.delta.proxy.Travel)
        {
            final com.sap.cap.sflight.delta.proxy.Travel var_value = ((com.sap.cap.sflight.delta.proxy.Travel)value);
            return var_value;
        }
        else
        {
