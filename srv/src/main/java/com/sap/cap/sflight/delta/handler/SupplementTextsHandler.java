...
public class SupplementTextsHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public SupplementTextsHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
