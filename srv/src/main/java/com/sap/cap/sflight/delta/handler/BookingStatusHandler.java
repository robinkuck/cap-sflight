...
public class BookingStatusHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public BookingStatusHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
