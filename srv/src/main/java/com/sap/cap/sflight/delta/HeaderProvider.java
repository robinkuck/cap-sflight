...
public class HeaderProvider extends com.sap.cap.sflight.delta.base.HeaderProviderBase {
    ...
    private static java.lang.ThreadLocal<HeaderProvider> instance = THREAD_LOCAL_INSTANCE ? new java.lang.ThreadLocal<HeaderProvider>() : null;
    ...
    public static StringSet initPropagate() {
        StringSet propagate = com.sap.cap.sflight.delta.base.HeaderProviderBase.initPropagate();
    ...
    @Override public void addHttpHeaders(HttpDestination destination, org.apache.hc.core5.http.HttpRequest request, HttpHeaders headers) {
        super.addHttpHeaders(destination, request, headers);
    }

    @Override public void addAuthorization(HttpDestination destination, org.apache.hc.core5.http.HttpRequest request, HttpHeaders headers) {
        super.addAuthorization(destination, request, headers);
    }

    @Override public void addConnectivity(HttpDestination destination, org.apache.hc.core5.http.HttpRequest request, HttpHeaders headers) {
        super.addConnectivity(destination, request, headers);
    }

    @Override public void onHttpResponse(HttpDestination destination, org.apache.hc.core5.http.HttpResponse response, HttpHeaders headers) {
