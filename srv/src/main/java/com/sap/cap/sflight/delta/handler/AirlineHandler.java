...
public class AirlineHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public AirlineHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
