...
public class RejectTravelHandler extends com.sap.cloud.server.odata.DefaultMethodHandler {
    ...
    public RejectTravelHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
