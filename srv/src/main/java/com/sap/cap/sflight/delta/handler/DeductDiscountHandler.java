...
public class DeductDiscountHandler extends com.sap.cloud.server.odata.DefaultMethodHandler {
    ...
    public DeductDiscountHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
