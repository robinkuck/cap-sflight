...
public class AcceptTravelHandler extends com.sap.cloud.server.odata.DefaultMethodHandler {
    ...
    public AcceptTravelHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
