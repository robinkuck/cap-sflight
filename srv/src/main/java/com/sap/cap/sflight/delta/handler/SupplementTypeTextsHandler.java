...
public class SupplementTypeTextsHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public SupplementTypeTextsHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
