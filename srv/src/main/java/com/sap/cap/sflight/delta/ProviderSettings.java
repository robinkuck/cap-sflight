...
public abstract class ProviderSettings {
    public static final boolean CAN_MODIFY_SCHEMA = false; // Is the provider allowed to modify the database schema, e.g. add tables?
    ...
    public static void init(OnlineODataProvider provider) {
        // Add customization of online OData settings here.
    }
