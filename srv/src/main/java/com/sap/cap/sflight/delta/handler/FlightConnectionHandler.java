...
public class FlightConnectionHandler extends com.sap.cloud.server.odata.DefaultEntityHandler {
    ...
    public FlightConnectionHandler(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
