...
public class FlightListener extends com.sap.cloud.server.odata.DefaultEntityListener {
    ...
    public FlightListener(com.sap.cap.sflight.delta.MainServlet servlet, com.sap.cap.sflight.delta.proxy.ProxyService service) {
        super();
    ...
    public void beforeSave(EntityValue entityValue) {
        ...
        var entity = (com.sap.cap.sflight.delta.proxy.Flight)entityValue;
        allowUnused(entity);
    }
